...
| Conventional | 3% | none | PMI ~0.5% below 20% down (varies by credit) | 3% under 10% down · 6% from 10% to under 25% · 9% at 25%+ (primary residence) |
| Cash | — | — | — | none |
...
Also confirm with the lender: the county's FHA and conforming loan limits, credit-score minimums, whether concessions can cover prepaids, and the realistic closing timeline.
