...
**Not in the table** (write them in `pricing.net_note`): property tax proration (Florida taxes are paid in arrears, so the seller credits the buyer from January 1 to closing, about one-twelfth of the annual bill per month), repairs after inspection, and carrying costs while the home is listed. If the seller is a foreign person, flag FIRPTA withholding and refer them to the title company or a CPA; it isn't computed.
